...
- (void)appendLeftText:(NSString *)left middleText:(NSString *)middle middleText1:(NSString *)middle1 rightText:(NSString *)right rightText1:(NSString *)right1 isTitle:(BOOL)isTitle
{
    ...
    if (left) {
        ...
        if (middle1) {
            [self setOffset:155 + offset];
            [self setText:middle1];
            [self setAlignment:HLTextAlignmentCenter];
