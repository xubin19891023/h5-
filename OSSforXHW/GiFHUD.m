...
//        设置整个uiview的背景颜色
        ...
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake((self.bounds.size.width-Size)/2, (self.bounds.size.height-Size)/2,135, 120)];
        ...
        self.lable.text=@"";
//        self.lable.textColor=[Utils getColor:@"999999"];
